...
export const load = async (gl: WebGLRenderingContext): Promise<Environment> => {
...
export const bind = (
	...
	brfdLutTarget: WebGLUniformLocation,
	diffuseTarget: WebGLUniformLocation,
	specularTarget: WebGLUniformLocation
) => {
